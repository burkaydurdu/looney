...
* [`src/looney/`](src/looney/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/looney/core.cljs): contains the SPA entry point, `init`
* [`test/looney/`](test/looney/): test files (ClojureScript,
...
5. Clone this repo and open a terminal in the `looney` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/looney/config.cljs) defaults to `true` in
...
```clj
(ns looney.example
  (:require [looney.config :as config])
